...
client = MongoClient('mongodb+srv://123:123@cluster0.vfdr0ej.mongodb.net/?retryWrites=true&w=majority')
db = client.dbLearningx_Tom
...
def detail(keyword):
    ...
    if type(definitions[0]) is str:
        return redirect(
            url_for("error", word=keyword, suggestions=",".join(definitions))
        )
